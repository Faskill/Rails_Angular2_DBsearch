...
CREATE TABLE users (
    ...
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    CONSTRAINT email_must_be_company_email CHECK (((email)::text ~* '^[^@]+@hotmail\.fr'::text))
);
...
INSERT INTO schema_migrations (version) VALUES ('20161116111623'), ('20161116115031'), ('20161116120724'), ('20161118115747');
